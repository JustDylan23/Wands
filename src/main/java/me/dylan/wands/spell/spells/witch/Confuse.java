...
public class Confuse implements Castable {
    ...
    public Behavior createBehaviour() {
        return Spark.newBuilder(Target.MULTI)
                ...
                .setEntityDamage(8)
                .setPotionEffects(new PotionEffect(PotionEffectType.NAUSEA, 260, 4, false))
                .setSpellRelativeEffects((loc, spellInfo) -> {
                    World world = spellInfo.world();
                    world.spawnParticle(Particle.LARGE_SMOKE, loc, 50, 1.4, 1.2, 1.4, 0.08, null, true);
                    world.spawnParticle(Particle.SMOKE, loc, 50, 1.4, 1.2, 1.4, 0.08, null, true);
                    world.spawnParticle(Particle.WITCH, loc, 50, 1.4, 1.2, 1.4, 0.15, null, true);
